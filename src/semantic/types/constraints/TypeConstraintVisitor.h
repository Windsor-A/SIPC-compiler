...
//SIP Additions - uncomment as implemented
  void endVisit(ASTArrayComprehensionExpr *element) override;
  void endVisit(ASTArrayLiteralExpr *element) override;
  void endVisit(ASTBooleanExpr *element) override;
  void endVisit(ASTBooleanNotExpr *element) override;
  void endVisit(ASTLengthExpr *element) override;
  void endVisit(ASTSubscriptExpr *element) override;
