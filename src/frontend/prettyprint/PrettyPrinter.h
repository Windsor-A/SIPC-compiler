...
public:
  ...
  virtual void endVisit(ASTSubscriptExpr *element) override;
  ...
  virtual void endVisit(ASTBooleanNotExpr *element) override;
  virtual void endVisit(ASTArrayLiteralExpr *element) override;
  virtual void endVisit(ASTArrayComprehensionExpr *element) override;
  // End SIP Extensions
