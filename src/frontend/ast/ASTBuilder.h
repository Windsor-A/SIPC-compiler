...
public:
  ...
  // subscriptExpr
  Any visitSubscriptExpr(TIPParser::SubscriptExprContext *ctx) override;
  // lenExpr
  ...
  // modulusExpr
  Any visitModulusExpr(TIPParser::ModulusExprContext *ctx) override;
  // andExpr
  ...
  // arrayLiteralExpr
  Any visitArrayLiteralExpr(TIPParser::ArrayLiteralExprContext *ctx) override;
  // arrayComprehensionExpr
  Any visitArrayComprehensionExpr(TIPParser::ArrayComprehensionExprContext *ctx) override;
  // incStmt
