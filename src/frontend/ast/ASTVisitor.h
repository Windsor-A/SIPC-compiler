...
public:
  ...
  virtual bool visit(ASTSubscriptExpr *element) { return true; }
  virtual void endVisit(ASTSubscriptExpr *element) {}
  ...
  virtual bool visit(ASTBooleanNotExpr *element) { return true; }
  virtual void endVisit(ASTBooleanNotExpr *element) {}
  virtual bool visit(ASTArrayLiteralExpr *element) { return true; }
  virtual void endVisit(ASTArrayLiteralExpr *element) {}
  virtual bool visit(ASTArrayComprehensionExpr *element) { return true; }
  virtual void endVisit(ASTArrayComprehensionExpr *element) {}
