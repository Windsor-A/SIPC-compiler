...
TEST_CASE("PrettyPrinter: Test ternary expression", "[PrettyPrinter]") {
  std::stringstream stream;
  stream << R"(
prog() { var x, y, z; output x?y:z; return z; })";
...
TEST_CASE("PrettyPrinter: Test Array Comprehension expression", "[PrettyPrinter]") {
    std::stringstream stream;
    stream << R"(
    prog() { var x, y, z; z = [x of y]; return x; })";
  std::string expected = R"(prog()
{
  var x, y, z;
  z = [x of y];
...
TEST_CASE("PrettyPrinter: Test Array Literal expression", "[PrettyPrinter]") {
std::stringstream stream;
stream << R"(
    prog() { var x, y, z; z = [x, 3, y]; return x; })";
...
TEST_CASE("PrettyPrinter: Test Binary expression w", "[PrettyPrinter]") {
std::stringstream stream;
stream << R"(
    prog() { var x, y, z; z = x or y; return x; })";
...
TEST_CASE("PrettyPrinter: Test Array Length expression", "[PrettyPrinter]") {
std::stringstream stream;
stream << R"(
    prog() { var x, y; y = #x; return y; })";
...
TEST_CASE("PrettyPrinter: Test Negation expression", "[PrettyPrinter]") {
std::stringstream stream;
stream << R"(
    prog() { var x, y; y = -x; return y; })";
...
TEST_CASE("PrettyPrinter: Test Subscript expression", "[PrettyPrinter]") {
std::stringstream stream;
stream << R"(
    prog() { var x, y, z; z = x[y]; return z; })";
...
TEST_CASE("PrettyPrinter: Test Decrement statement", "[PrettyPrinter]") {
std::stringstream stream;
stream << R"(
    prog() { var x, y, z; x--; return z; })";
...
TEST_CASE("PrettyPrinter: Test SIP Extensions", "[PrettyPrinter]") {
  std::stringstream stream;
  stream
      << R"(
main() {
